...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 23 18:17:40 2023
...
#        print(results[1])
    ...
    data = (varlist, wind_cost, sun_cost, batt_cost, pgp_cost, elec_cap, sys_cost, topgp_cost, storagepgp_cost,frompgp_cost)
    return data
...
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/toPGPeff'
...
pal = ['blue', 'orange', 'purple', 'lightpink','tab:pink','m']
...
ax1.set_title('Efficicency sensitivity')
...
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/fromPGPeff'
...
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/toPGPcost'
...
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/fromPGPcost'
...
ax5.set_title('Capital cost sensitivity')
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/storagePGPcost'
...
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/storagePGPdecay'
...
plt.tight_layout()
plt.savefig('val_innovation_pem.pdf', bbox_inches='tight')
plt.savefig('val_innovation_pem.png', bbox_inches='tight')
plt.savefig('val_innovation_pem.svg', bbox_inches='tight')
