...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 13:29:10 2023
...
def makeplot(ISO):
    ...
    #======================================================
    path = '/Users/jacquelinedowling/MEM/Output_Data/rtePGPeff_ISOs/' + ISO
    ...
    plt.tight_layout()
    plt.savefig('fig_disp_rte_costs_' + ISO +'.pdf', bbox_inches='tight')
    plt.show()
    return
