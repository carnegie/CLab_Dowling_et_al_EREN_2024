...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 22 16:14:03 2023
...
#======================================================
path = '/Users/jacquelinedowling/MEM/Output_Data/rtePGPeff'
...
pal = ['blue', 'orange', batt_c, pgp_c,pgp_sc,pgp_fc]
...
#plotting Linear
ax6 = plt.subplot2grid((3, 1), (0, 0), colspan=1, rowspan=1)
...
pal1 = [wind_c, solar_c, batt_c, pgp_fc]
...
ax1.plot(x, cost_elec_to_PGP, color = pgp_c, label = 'Power-to-H$_{2}$\nbuying',linewidth=2)
ax1.plot(x, cost_elec_from_PGP, color = pgp_fc, label = 'H$_{2}$-to-Power\nselling',linewidth=2)
...
plt.tight_layout()
# plt.savefig('fig_disp_rte_costs.pdf', bbox_inches='tight')
plt.show()