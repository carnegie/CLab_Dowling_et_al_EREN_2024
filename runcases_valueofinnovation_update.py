...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 28 17:41:53 2023
...
# RUN THIS NEXT
case_input_path_filename ='/Users/jacquelinedowling/MEM/PGP_basecase_14Oct2022_natgas5pct.csv'
...
def run_condition(knob, idx, var, therange, case_name_orig, output_path_orig):
    ...
    case_dic['output_path'] = output_path_default + '/' + knob + "_5pctNG"
    for val in therange:
    #set this index for correct tech and knob!
        tech_list[idx][var] = val 
        case_dic['case_name'] = case_name_default + '_5pctNG_'+ knob + '_' + str(val)
