...
case_input_path_filename = '/Users/jacquelinedowling/MEM/PGP_basecase_14Oct2022_MISO.csv'

# case_input_path_filename = '/Users/jacquelinedowling/MEM/PGP_basecase_14Oct2022_ISNE.csv'

# case_input_path_filename = '/Users/jacquelinedowling/MEM/PGP_basecase_14Oct2022_ERCOT.csv'

# case_input_path_filename = '/Users/jacquelinedowling/MEM/PGP_basecase_14Oct2022_CISO.csv'
...
# therange = [.6]
print(therange)
run_condition('rtePGPeff', to_PGP_idx, from_PGP_idx,'efficiency',  therange, case_name_orig, output_path_orig)
